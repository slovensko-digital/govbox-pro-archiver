package digital.slovensko.archiver.server.filters;
 ...
 */
public class ArchiverCorsFilter extends Filter {
    private final List<String> allowedMethods;

    public ArchiverCorsFilter(String allowedMethod) {
        this(List.of(allowedMethod));
    }

    public ArchiverCorsFilter(List<String> allowedMethod) {
